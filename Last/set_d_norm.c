...
/*   Updated: 2016/03/08 13:06:51 by jle-quer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*set_moins_d_norm_2(t_struct *form, char *str, char *larg, int n)
{
	char	*new;
...
char		*set_moins_d_norm(t_struct *form, char *str, char *larg, int n)
{
	char *new;
